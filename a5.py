...
class Body(tk.Frame):
    ...
    def set_posts(self, posts:list):
        ...
        # widget.
        self._posts = posts
        for count, value in enumerate(self._posts):
            self._insert_post_tree(count, value)
...
class MainApp(tk.Frame):
    ...
    def save_profile(self):
        ...
        if self._is_online is True:
            send('168.235.86.101', 3021, 'gremlin', 'grrrr', self._current_profile, new)
